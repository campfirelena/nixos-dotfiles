...
#      Type = "oneshot";
#      RemainAfterExit = "yes";
#      ExecStart = pkgs.writeScript "flatpak-management.sh" ''
#        #!${pkgs.runtimeShell} -e
...
#          if ! echo ${lib.concatStringsSep " " home.flatpak.packages} | grep -q "$installed"; then
...
#        for app in ${lib.concatStringsSep " " home.flatpak.packages}; do
